...
<body>
  ...
  h3 img {
    margin-right: 10px; /* Espacio entre la imagen y el texto */
                ...
                <h3><img src="../alumno/images/logoUMC.png" class="img-fluid" /><span>Urbana Mixta Concepción</span></h3>
			</div>
								...
								<nav class="navbar p-0">
									<ul class="nav navbar-nav flex-row ml-auto">
										...
										<li class="dropdown nav-item">
											...
											<a class="nav-link" href="#" data-toggle="dropdown">
												<img src="../alumno/images/user.png"
													style="width:40px; border-radius:50%;" />
												<span class="xp-user-live"></span>
											</a>
...
-->
			...
			<div class="main-content" id="tabla-productos">
				...
				<div class="col-md-12">
					...
					$sqlCliente = ("SELECT alumno,nombre,tema,
					docente,
					nivel,grado,turno,usuario_alumno
					FROM curso
									...
									while ($data = mysqli_fetch_array($queryCliente)) { ?>
										<tr>
											...
											<td>
												...
												<a
													href="../alumno/alumno-asistencia.php?usuario=<?php $usuario = $_SESSION['alumno']['usuario']; echo $usuario ?>&alumno=<?php echo $data['alumno'] ?>&docente=<?php echo $data['docente'] ?>&nivel=<?php echo $data['nivel'] ?>&tema=<?php echo $data['tema'] ?>&grado=<?php echo $data['grado'] ?>">

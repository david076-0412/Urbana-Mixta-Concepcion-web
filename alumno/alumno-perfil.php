...
<body>
  ...
  h3 img {
								...
								<center>
									<p>
										...
										?>
											...
											<img src="../alumno/images/user.png" style="width:180px; border-radius:50%;" alt="Foto del Usuario">
															...
															<table class="table table-striped table-hover">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td>
																			<a href="#ModalPerfilAlumno<?php echo $fila['usuario']; ?>" class="edit" data-toggle="modal">
																				<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
															...
															<table class="table table-striped table-hover">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td>
																			<a href="#ModalPerfilAlumno<?php echo $row['usuario']; ?>" class="edit" data-toggle="modal">
																				<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
	...
	<link rel="stylesheet" href="../alumno/stylecss/stylemaass.css">


	<!--ventana para Update--->
	<div class="modal fade" id="ModalPerfilAlumno<?php echo $row['usuario']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="POST" action="../alumno/actualizar_perfil.php?usuario=<?php echo $row['usuario']; ?>">
					...
					<div class="modal-body" id="cont_modal">
						...
						<div class="form-group-modal">
							...
							<input type="text" class="input-text" required name="alumno" id="alumno" value="<?php echo $row['alumno']; ?>" onkeypress="soloLetras(event)"><br>
	...
	<div class="modal fade" id="fotoperfil<?php echo $fila['usuario']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="POST" action="../alumno/actualizar_foto_perfil.php?usuario=<?php echo $fila['usuario']; ?>" enctype="multipart/form-data">

...
<!--ventana para Update--->
<div class="modal fade" id="vertarea<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="../alumno/subir_tarea.php?id=<?php echo $data['id']; ?>&usuario=<?php echo $data['usuario']; ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body" id="cont_modal">
                    ...
                    <div class="form-group">
                        ...
                        <strong style="text-align: left; text-transform: none !important; word-wrap: break-word; white-space: normal; overflow-wrap: break-word; display: block;">
            <?php echo $data['descripcion']; ?>
                        ...
                        <?php
                        $archivotarea = $data['archivotarea'];
                        

                        if ($archivotarea != NULL) {
                        ?>
                            <a href="../alumno/mostrar_tarea.php?titulo=<?php 
                            echo $data['titulo'] ?>&materia=<?php 
                            echo $data['materia']; ?>&docente=<?php 
                            echo $data['docente']; ?>&tema=<?php 
                            echo $data['tema']; ?>&nivel=<?php 
                            echo $data['nivel']; ?>&grado=<?php 
                            echo $data['grado']; ?>" 
                            target="_blank">
                            ...
                            <p><a href="../alumno/descargar_tarea.php?titulo=<?php 
                            echo $data['titulo'] ?>&materia=<?php 
                            echo $data['materia']; ?>&docente=<?php 
                            echo $data['docente']; ?>&tema=<?php 
                            echo $data['tema']; ?>&nivel=<?php 
                        ...
                        ?>
                            ...
                            <input type="file" required name="subirarchivotarea" required="" id="subirarchivotarea"><br>
                        ...
                        <strong style="text-align: center; text-transform: none !important">
                            ...
                            <input type="file" class="invisible" required name="subirarchivotarea" required="" id="subirarchivotarea"><br>

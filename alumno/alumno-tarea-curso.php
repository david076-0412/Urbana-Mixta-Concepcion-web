                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                            <tr>
                                                ...
                                                <a href="../alumno/alumno-tarea.php?usuario=<?php 
                                                $usuario = $_SESSION['alumno']['usuario']; 
                                                echo $usuario ?>&alumno=<?php 
                                                echo $data['alumno']; ?>&docente=<?php 
                                                echo $data['docente']; ?>&nivel=<?php 
                                                echo $data['nivel']; ?>&grado=<?php 
                                                echo $data['grado']; ?>&materia=<?php 
                                                echo $data['nombre']; ?>&tema=<?php 
                                                echo $data['tema']; ?>">

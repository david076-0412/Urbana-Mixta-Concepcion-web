...
<head>
    ...
    <link rel="stylesheet" href="../alumno/css/customss.css">
            ...
            <div class="main">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box-container">
                        ...
                        AND nivel='$nivel' 
                        AND grado='$grado' AND curso='$curso' 
                        AND tema='$tema'";
                                ...
                                <div style="background-color: #ADC8FF; height: 330px; width: 750px;" class="box-bx">
                                    ...
                                    <div style="background-color: #F8FAFD; height: 310px; width: 730px;" class="box-b">
                                            ...
                                            <h2>Nota Final :
                                                ...
                                                if ($cantidad > 0) {
                                                    ...
                                                    if ($contador > 0) {
                                                        ...
                                                        echo "No hay notas para calcular el promedio.";
                                                    }
                                        ...
                                        /*$query = $conexion->query("
                                          SELECT 
                                          tipo_nota_promedio, nota_promedio,alumno
                                          FROM notas AND alumno='$alumno'
                                        ");
                                      */

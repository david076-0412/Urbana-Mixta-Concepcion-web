            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="dropdown">
                    ...
                    <?php while ($data = mysqli_fetch_array($queryCliente)) { ?>
                        ...
                        $usuario = $_SESSION['usuario']; echo "$usuario"; ?>&alumno=<?php echo $data['alumno'] ?>" class="dashboard"><i class="material-icons">equalizer</i>
                            Asistencia</a>
                ...
                <?php
                    ...
                    $usuario = $_SESSION['usuario']; echo "$usuario"; ?>&alumno=<?php echo $data['alumno'] ?>" class="dashboard"><i class="material-icons">date_range</i>
						Notas</a>
...
-->
            ...
            <div class="main-content" id="tabla-productos">
                ...
                <div class="col-md-12">
                    ...
                    $usuario_alumno = $_REQUEST['usuario'];
                    ...
                    $sqlCliente = ("SELECT DISTINCT usuario_alumno,id,nombre,tema, 
                    docente,
                    nivel,grado,turno,archivomaterial 
                    FROM curso 
                            ...
                            <table id="example" class="table table-bordered table-hover" style="width:100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:180px; background-color: #5DACCD; color:#fff">Turno</th>
                                ...
                                <tbody>
                                    <?php while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                        ...
                                        <?php include('../alumno/Modal//ModalVerMaterial.php'); ?>

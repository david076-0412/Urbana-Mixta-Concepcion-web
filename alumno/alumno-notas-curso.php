...
-->
			...
			<div class="main-content" id="tabla-productos">
				...
				<div class="col-md-12">
					...
					$sqlCliente = ("SELECT DISTINCT usuario_alumno,alumno,nombre,tema,docente,nivel,grado,turno 
					FROM curso 
					WHERE alumno='$alumno'");
					$queryCliente = mysqli_query($conexion, $sqlCliente);
									...
									while ($data = mysqli_fetch_array($queryCliente)) { ?>
										<tr>
											...
											<td>
												...
												<a href="../alumno/alumno-notas.php?usuario=<?php $usuario = $_SESSION['alumno']['usuario'];
														echo $usuario ?>&alumno=<?php echo $data['alumno']; ?>&docente=<?php echo $data['docente']; ?>&nivel=<?php echo $data['nivel']; ?>&grado=<?php echo $data['grado']; ?>&curso=<?php echo $data['nombre']; ?>&tema=<?php echo $data['tema']; ?>">

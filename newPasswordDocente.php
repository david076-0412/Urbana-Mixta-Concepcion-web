...
<body style="background-image: url('imagen/fondo-login-docente.png'); background-size: cover; background-position: center; height: 100vh;" oncontextmenu='return false' class='snippet-body bg-info'>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-5">
                    ...
                    <div class="container bg-white rounded mt-2 mb-2 px-0">
                        ...
                        <div class="pt-3 pb-3">
                            <form class="form-horizontal" action="../newPasswordOtpDocente.php?email=<?php $email=$_REQUEST['email']; echo $email ?>" method="POST">
                                <!-- User Name Input -->
            ...
            this.classList.toggle('bx-show');
                        ...
                        <div class="mx-0 px-0 bg-light">
                            ...
                            <div class="pt-2">
                                <div class="row justify-content-center">
                                    <h5>
                                        Regresar al Login?<span><a href="../logindocentee.php" class="text-danger">Regresar a Loguear!</a></span>
                                    </h5>
                                </div>

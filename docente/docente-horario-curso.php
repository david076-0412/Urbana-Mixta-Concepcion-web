                                    ...
                                    while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../docente/docente-alumno-horario.php?usuario=<?php $usuario = $_SESSION['docente']['usuario'];
                                                                                                        echo "$usuario"; ?>&usuario_docente=<?php $usuario = $_SESSION['docente']['usuario'];

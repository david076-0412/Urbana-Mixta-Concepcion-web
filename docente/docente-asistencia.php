                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-lg-3 order-3 order-md-2">
                            <div class="xp-searchbar">
                                ...
                                <form method="post" action="docente-asistencia.php?usuario=<?php $usuario = $_SESSION['docente']['usuario'];
                                                                                            echo "$usuario"; ?>">
                                    ...
                                    <div class="input-group" >
                                        ...
                                        <select name="fecha_inicio" id="fecha_inicio" class="form-control">
                                            ...
                                            $consulta = "SELECT DISTINCT a.fecha_inicio,a.fecha_fin FROM asistencia a";
                                            ...
                                            while ($fila = mysqli_fetch_assoc($resultado)) {
                                                ...
                                                echo "<option value='" . $fila['fecha_inicio'] . "'>" . $fecha_inicio ." - ".$fecha_fin. "</option>";
                                            }
...
-->
            ...
            <div class="main-content" id="tabla-productos">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#nuevasistencia">
                    Nueva Asistencia

                </button>

                <?php include("../docente/Modal/ModalNuevaAsistencia.php") ?>
                ...
                <div class="col-md-12">
                    ...
                    ?>
                            ...
                            $sqlClienteaa   = ("SELECT * FROM asistencia WHERE fecha_inicio = '$fecha_inicio' ORDER BY STR_TO_DATE(hora, '%h:%i %p')");
                            $queryClientedd = mysqli_query($conexion, $sqlClienteaa);
                            $cantidad     = mysqli_num_rows($queryClientedd);
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="example" class="table-bordered table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <td style="width:120px; text-align: center; background-color: #5DACCD; color:#fff">Hora</td>
                                                <td style="width:120px; text-align: center; background-color: #5DACCD; color:#fff">Dia</td>
                                                <td style="width:120px; text-align: center; background-color: #5DACCD; color:#fff">Alumno</td>
                                                <td style="width:160px; text-align: center; background-color: #5DACCD; color:#fff">Tipos de Asistencia</td>
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($data = mysqli_fetch_array($queryClientedd)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#editarasistencia<?php echo $data['id']; ?>">
                                                            <span class="material-icons">edit</span>

                                                        </button>

                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#verasistencia<?php echo $data['id']; ?>">
                                                            <span class="material-icons">search</span>

                                                        </button>


                                                        <a href="../docente/eliminarasistencia.php?id=<?php echo $data['id']; ?>&usuario=<?php echo $data['usuario_docente']; ?>&docente=<?php echo $data['docente']; ?>">
                                                ...
                                                <?php include("../docente/Modal/ModalEditarAsistencia.php") ?>

                                                <?php include("../docente/Modal/ModalVerAsistencia.php") ?>
                        ...
                        ?>
                            ...
                            $sqlClienteaa   = ("SELECT * FROM asistencia ORDER BY dia ASC, STR_TO_DATE(hora, '%h:%i %p')");
                            $queryClientedd = mysqli_query($conexion, $sqlClienteaa);
                            $cantidad     = mysqli_num_rows($queryClientedd);

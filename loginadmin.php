    ...
    if (isset($_SESSION['admin']['usuario'])) {
        ...
        if ($result) {
           $_SESSION['admin']['usuario'] = $usu;
            ...
            header("Location: ../loginadmin.php?error=Usuario no encontrado");
            exit();
        }
    }
    ?>
	...
	<div class="contenedor-formulario contenedor">
		...
		<div class="wrapper">
			<form id="panel-i" action="../panel_inicio.php" method="post">
		  	...
		  	<form action="../usuario-roladmin.php" method="post">
			    <center>
			        <div class="brand">
  ...
  #myInput::placeholder {
    ...
    opacity: 1; /* Para asegurar que el color blanco se vea bien */
				...
				<div class="remember-forgot">
				    <a href="../forgotPasswordAdmin.php" style="color:blue;text-align: center; margin: 0 auto; width: 80%; color:#fff">Recuperar Contraseña?</a>
				</div>

    ...
    margin-right: 10px; /* Espacio entre la imagen y el texto */
        ...
        <div id="content" style="background-color: transparent;">
            ...
            <div class="main-content">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#nuevochatbot">
                    Nuevo Chat

                </button>

                <?php include("../administrador/Modal/ModalNuevoChat.php") ?>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example" class="table-bordered table-hover" style="width:100%">
                                ...
                                <thead>
                                    <tr>
                                        <td style="width:120px; background-color: #5DACCD; color:#fff">#Preguntas</td>
                                        <td style="width:100px; background-color: #5DACCD; color:#fff">Respuestas</td>
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($queryClienteff)) { ?>
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $data['queries'] ?>
                                            </td>

                                            <td>
                                                <?php echo substr($data['replies'], 0, 30) ?>
                                            </td>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#editarchat<?php echo $data['id']; ?>">
                                                    <span class="material-icons">edit</span>

                                                </button>


                                                <a href="../administrador/eliminarchat.php?id=<?php echo $data['id']; ?>&usuario=<?php $usuario = $_SESSION['admin']['usuario'];
                                                                                                                                    echo $usuario; ?>">
                                        ...
                                        <?php include('../administrador/Modal/ModalEditarChat.php'); ?>

    ...
    margin-right: 10px; /* Espacio entre la imagen y el texto */
        ...
        <div id="content">
            ...
            <div class="main-content">
                ...
                <?php include("../administrador/Modal/ModalNuevaSolicitudAlumno.php") ?>

                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#versolicitud">
                ...
                <?php include("../administrador/Modal/ModalVerSolicitud.php") ?>
                ...
                <div class="col-md-12">
                    ...
                    $sqlClienteff   = ("SELECT * FROM solicitud WHERE usuario = '$usuario_apoderado'");
                                    ...
                                    <?php while ($data = mysqli_fetch_array($queryClienteff)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../administrador/eliminarsolicitudalumno.php?id=<?php echo $data['id']; ?>&usuario=<?php $usuario = $_SESSION['admin']['usuario'];
                                        ...
                                        <?php include('../administrador/Modal/ModalEditarSolicitudAlumno.php'); ?>

...
<body style="background-image: url('imagen/fondo-login.jpg'); background-size: cover; background-position: center; height: 100vh;">
    ...
    if (isset($_SESSION['apoderado']['usuario'])) {
        $usu = $_SESSION['apoderado']['usuario'];
        ...
        if ($result) {
            ...
            header("Location: ../loginapoderado.php?error=Usuario no encontrado");
            exit();
        }
    }
    ?>
	...
	<div class="contenedor-formulario contenedor">
		...
		<div class="wrapper">
			<form id="panel-i" action="../panel_inicio.php" method="post">
		  	...
		  	<form action="../usuario-rolapoderado.php" method="post">
			    <center>
			        <div class="brand">
  ...
  #myInput::placeholder {
    ...
    opacity: 1; /* Para asegurar que el color blanco se vea bien */
				...
				<div class="remember-forgot">
				    <a href="../forgotPasswordapoderado.php" style="color:blue;text-align: center; margin: 0 auto; width: 80%; color:#fff">Recuperar Contraseña?</a>
				</div>

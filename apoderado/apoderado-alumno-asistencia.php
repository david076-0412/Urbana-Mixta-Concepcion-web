                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-lg-3 order-3 order-md-2">
                            ...
                            <div class="xp-searchbar">
                                ...
                                <form method="post" action="apoderado-alumno-asistencia.php?usuario=<?php $usuario = $_SESSION['apoderado']['usuario'];
                                                                                                    echo "$usuario"; ?>">
                                    ...
                                    <table id="example" class="table table-bordered table-hover" style="width:100%">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td style="width:180px; background-color: #5DACCD; color:#fff">Número Documento</td>
                                                ...
                                                <td style="width:180px; background-color: #5DACCD; color:#fff">Sexo</td>
                                                <td style="width:180px; background-color: #5DACCD; color:#fff">Accion</td>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <?php while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="../apoderado/apoderado-asistencia-cursos.php?usuario=<?php $usuario = $_SESSION['apoderado']['usuario']; echo $usuario ?>&alumno=<?php echo $data['alumno'] ?>">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="example" class="table table-bordered table-hover" style="width:100%">
                                        ...
                                        <thead>
                                            <tr>
                                                <td style="width:120px; background-color: #5DACCD; color:#fff">Alumnos
                                                </td>
                                                <td style="width:180px; background-color: #5DACCD; color:#fff">Número Documento</td>
                                                <th style="width:180px; background-color: #5DACCD; color:#fff">Nivel</th>
                                                <th style="width:180px; background-color: #5DACCD; color:#fff">Grado</th>
                                                <th style="width:180px; background-color: #5DACCD; color:#fff">Sexo</th>

                                                <th style="width:180px; background-color: #5DACCD; color:#fff">Acción</th>
                                            </tr>
                                        </thead>

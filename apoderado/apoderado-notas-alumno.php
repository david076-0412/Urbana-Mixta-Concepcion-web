                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-lg-3 order-3 order-md-2">
                            ...
                            <div class="xp-searchbar">
                                ...
                                <form method="post" action="apoderado-notas-alumno.php?usuario=<?php $usuario = $_SESSION['apoderado']['usuario'];
                                                                                                echo "$usuario"; ?>">
                ...
                <div class="col-md-12">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($ano != NULL) {
                            ...
                            WHERE usuario_apoderado = '$usuario' 
                            AND ano_inscrip = '$ano' ORDER BY ano_inscrip DESC");
                    ...
                    ?>
                                    ...
                                    <table id="example" class="table table-bordered table-hover" style="width:100%">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td style="width:180px; background-color: #5DACCD; color:#fff">Número de Documento
                                                </td>
                                                <td style="width:180px; background-color: #5DACCD; color:#fff">Sexo</td>
                                                <td style="width:180px; background-color: #5DACCD; color:#fff">Acción</td>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <?php while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="../apoderado/apoderado-cursos-notas.php?usuario=<?php echo $data['usuario_apoderado']; ?>&alumno=<?php echo $data['alumno'] ?>">
                        ...
                        <?php
                            ...
                            $sqlCliente = ("SELECT * FROM alumno 
                            where usuario_apoderado = '$usuario' ORDER BY ano_inscrip DESC");
                            $queryCliente = mysqli_query($conexion, $sqlCliente);
                            $cantidad = mysqli_num_rows($queryCliente);

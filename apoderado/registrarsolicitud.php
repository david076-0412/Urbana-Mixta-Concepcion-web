...
if (
    ...
    header("Location: ../apoderado/apoderado-solicitud.php?usuario=$usuario");
} else {
...
foreach ($alumnos_seleccionados as $alumno_id) {
 ...
 $query = "INSERT INTO solicitud (usuario,alumno,cod_solicitud,fecha,periodo,categoria_solicitud,servicio,estado,importe,usuario_alumno) 
    VALUES ('$usuario','$alumno_id','$cod_solicitud','$fecha','$periodo','$categoria_solicitud','$servicio','en espera','$importe','$usuario_alumno')";

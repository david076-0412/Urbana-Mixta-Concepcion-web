            ...
            <div class="top-navbar">
                <div class="xd-topbar">
                    ...
                    <div class="xp-breadcrumbbar text-center">
                        <h4 class="page-title">Alumnos - Tutoría</h4>
...
-->
            ...
            <div class="main-content" id="tabla-productos">
                ...
                <h2 class="ml-lg-2">Lista de Alumnos - Tutoría</h2>
                ...
                <div class="col-md-12">
                    ...
                    $sqlCliente   = ("SELECT * FROM alumno WHERE usuario_apoderado = '$usuario'");
                                    ...
                                    while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../apoderado/apoderado-tutoria.php?usuario=<?php echo $data['usuario_apoderado'] ?>&nivel=<?php echo $data['nivel']; ?>&grado=<?php echo $data['grado']; ?>&usuario_alumno=<?php echo $data['usuario']; ?>&curso=Tutoría">

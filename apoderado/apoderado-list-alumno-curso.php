                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-lg-3 order-3 order-md-2">
                            ...
                            <div class="xp-searchbar">
                                ...
                                <form method="post" action="apoderado-list-alumno-curso.php?usuario=<?php $usuario = $_SESSION['apoderado']['usuario'];
                                                                                                    echo "$usuario"; ?>">
                                        ...
                                        <tbody>
                                            <?php while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="../apoderado/apoderado-list-curso.php?usuario=<?php echo $data['usuario_apoderado'] ?>&alumno=<?php echo $data['alumno'] ?>">
                                                ...
                                                <?php include('../apoderado/ModalPagosAlumno.php'); ?>

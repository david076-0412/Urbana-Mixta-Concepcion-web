            ...
            <div class="top-navbar">
                <div class="xd-topbar">
                    ...
                    <div class="xp-breadcrumbbar text-center">
                        <h4 class="page-title">Alumnos - Pagos</h4>
...
-->
            ...
            <div class="main-content" id="tabla-productos">
                ...
                <h2 class="ml-lg-2">Lista de Alumnos - Pagos</h2>
                                    ...
                                    while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a
                                                    href="../apoderado/apoderado-pagos.php?usuario=<?php echo $data['usuario_apoderado']; ?>&usuario_alumno=<?php echo $data['usuario'] ?>&nivel=<?php echo $data['nivel'] ?>">

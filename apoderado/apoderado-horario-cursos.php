...
-->
            ...
            <div class="main-content" id="tabla-productos">
                ...
                <div class="col-md-12">
                    ...
                    $sqlCliente = ("SELECT * FROM alumno WHERE usuario_apoderado = '$usuario' order by grado desc");
                                    ...
                                    while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a
                                                    href="../apoderado/apoderado-alumno-horario.php?usuario=<?php echo $data['usuario_apoderado']; ?>&nivel=<?php echo $data['nivel']; ?>&grado=<?php echo $data['grado']; ?>">
